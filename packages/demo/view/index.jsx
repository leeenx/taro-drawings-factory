...
export default memo(() => {
  ...
  const handleLoadMoreClick = useMemoizedFn(() => {
    setState({
  ...
  const handleStepsChange = useMemoizedFn((stateName, current) => {
    setState({
      [stateName]: current
    })
  });

  const handleHollowClick = useMemoizedFn((data) => {
    ...
    setState({ hollowTagList })
  });

  const handleSolidClick = useMemoizedFn((data) => {
    ...
    setState({ solidTagList })
  });

  const handleHollowSmallClick = useMemoizedFn((data) => {
    ...
    setState({ hollowTagList2 })
  });

  const handleSolidSmallClick = useMemoizedFn((data) => {
    ...
    setState({ solidTagList2 })
  });

  const { isCurtainOpened, loadMoreStatus } = state
    ...
    return (
      <View className='page'>
            ...
            <View className='panel__content'>
              ...
              <View className='example-item example-item--steps'>
                <AtSteps
                  ...
                  current={state.stepsCurrent1}
                  onChange={() => handleStepsChange('stepsCurrent1')}
                />
              </View>
              ...
              <View className='example-item example-item--steps'>
                <AtSteps
                  ...
                  current={state.stepsCurrent2}
                  onChange={() => handleStepsChange('stepsCurrent2')}
                />
              </View>
              ...
              <View className='example-item example-item--steps'>
                <AtSteps
                  ...
                  current={state.stepsCurrent3}
                  onChange={() => handleStepsChange('stepsCurrent3')}
                />
              </View>
              ...
              <View className='example-item example-item--steps'>
                <AtSteps
                  ...
                  current={state.stepsCurrent4}
                  onChange={() => handleStepsChange('stepsCurrent4')}
                />
              </View>
        ...
        <AtCurtain
          ...
          onClose={() => handleCurtainClick(false)}
        >
          <Image
            style='width:100%'
            mode='widthFix'
