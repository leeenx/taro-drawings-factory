...
export default memo(() => {
  ...
  const handleFloatLayoutChange = useMemoizedFn((flag) => {
    setState({
      ...state,
  ...
  return (
    <View className='page'>
      {/* S Header */}
      <DocHeader title='布局' desc='6 个组件'></DocHeader>
      {/* E Header */}
      ...
      <View className='doc-body'>
        ...
        <View className='panel'>
          ...
          <View className='panel__content'>
            <View className='example-item'>
              ...
              <AtGrid data={state.data} />
            </View>

            <View className='example-item'>
              <View className='example-item__desc'>矩形案例</View>
              <AtGrid mode='rect' data={state.data} />
            </View>

            <View className='example-item'>
              <View className='example-item__desc'>没有边框</View>
              <AtGrid hasBorder={false} data={state.data} />
            </View>
          </View>
        </View>
        ...
        <View className='panel'>
          ...
          <View className='panel__content'>
            <View className='example-item'>
              <View className='demo-btn' onClick={() => handleFloatLayoutChange(true)}>打开 Float Layout</View>
            </View>
          </View>
        </View>
      ...
      <AtFloatLayout
        title='这是个标题'
        isOpened={state.isFloatLayoutOpened}
